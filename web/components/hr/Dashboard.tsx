    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center gap-3 px-6 py-4 border-b border-border bg-card shrink-0">
          ...
          <button
            onClick={() => setSearchQuery(searchQuery)} // effectively a no-op submit
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  <th className="text-left px-4 py-3 font-semibold text-muted-foreground text-xs uppercase tracking-wide">Imię</th>
                  <th className="text-left px-4 py-3 font-semibold text-muted-foreground text-xs uppercase tracking-wide">Nazwisko</th>
                  <th className="text-left px-4 py-3 font-semibold text-muted-foreground text-xs uppercase tracking-wide">Stanowisko</th>
                  <th className="text-left px-4 py-3 font-semibold text-muted-foreground text-xs uppercase tracking-wide">Lokalizacja</th>
                ...
                {filteredEmployees.map((emp, i) => {
                  ...
                  return (
                    <tr
                      ...
                      `}
                    >
                      <td className="px-4 py-3 font-medium text-foreground">{emp.firstName}</td>
                      <td className="px-4 py-3 text-foreground">{emp.lastName}</td>
