...
import { WorkDimension, DIMENSION_LABEL } from "@/lib/hr-data";

const WORK_DIMENSIONS: WorkDimension[] = [
  "1",
  "7/8",
  "3/4",
  "5/8",
  ...
  return (
    <div className="flex flex-col gap-1.5" ref={ref}>
      ...
      <div className="relative">
        ...
        {open && (
          <div
            className={`${DROPDOWN_PANEL} ${maxHeightClass}`}
            role="listbox"
          >
            {options.map((option) => (
              <button
...
export function isOvernight(startHour: string, endHour: string): boolean {
